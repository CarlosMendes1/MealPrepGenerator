...
const PROFILE_COLUMNS =
  'user_id, role, full_name, age, weight_kg, height_cm, body_fat_pct, goal, calorie_target, allergies, intolerances, dietary_preferences, lifestyle_notes, nutritionist_id, ai_coach_enabled, created_at, updated_at';
